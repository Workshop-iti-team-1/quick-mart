...
auth_ds_group = get_group_from_path(project, 'QuickMart/Presentation/Authentication/Data/DataSources')
add_files_to_group(project, target, auth_ds_group, 'QuickMart/Presentation/Authentication/Data/DataSources')
